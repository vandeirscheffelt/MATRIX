"""Muda URL do Baixar Audio Interno para localhost:8080 (mesmo servidor, sem proxy Speedfy)."""
...
# Usar localhost:8080 — mesmo servidor, sem passar pelo proxy Speedfy
# curl com localhost funcionou; URL externa falha (proxy interfere)
new_url = "={{ 'http://localhost:8080/chat/getBase64FromMediaMessage/' + $('Webhook EVO').item.json.body.instance }}"
