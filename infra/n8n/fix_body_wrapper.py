...
# Expressao correta: wrapper { message: $json.message } para Evolution API
correct_body = '={{ JSON.stringify({ message: $json.message }) }}'

for n in wf['nodes']:
    if n['name'] == 'Baixar Audio Interno':
        n['parameters']['body'] = correct_body
        print('body corrigido: ' + correct_body)
        break
